...
static inline iFloat4 init128_F4(__m128 m) {
    return (iFloat4){ m };
}
...
static inline iFloatVec3 values_F3(const iFloat3 d) {
    return (iFloatVec3){ .value = { x_F3(d), y_F3(d), z_F3(d) } };
}

static inline void load_F3(const iFloat3 d, float *p_out) {
    p_out[0] = x_F3(d);
    p_out[1] = y_F3(d);
    p_out[2] = z_F3(d);
}
...
static inline unsigned mask_F3  (const iFloat3 a)   { return _mm_movemask_ps(a.m) & 7; }
...
static inline iFloat4 sqrt_F3   (const iFloat3 a)       { return (iFloat3){ _mm_sqrt_ps(a.m) }; }
